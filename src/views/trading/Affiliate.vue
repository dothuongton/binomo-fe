...
<!--              <div class="vx-col lg:w-4/12">-->
<!--                <p class="title-vip font-bold white line-height-normal mb-4">-->
<!--                  {{$t("You need to become a VIP Member to receive VIP commissions and transaction")}}-->
<!--                </p>-->
<!--                <p class="font-bold" style="color: #fa8d29">-->
<!--                 * {{$t('Register VIP to receive referral link')}}-->
<!--                </p>-->
<!--                <br/>-->
<!--                <vs-button-->
<!--                  size="large"-->
<!--                  style="background: #eec40d !important; color: #000 !important"-->
<!--                  type="filled"-->
<!--                  @click="popupBuyThamGiaVip = true"-->
<!--                  >{{$t('Buy now')}} $100</vs-button-->
<!--                >-->
<!--              </div>-->
<!--&lt;!&ndash;              <div class="vx-col w-full lg:w-4/12">&ndash;&gt;-->
<!--&lt;!&ndash;                <div class="affiliateInfo borderPrimary">&ndash;&gt;-->
<!--&lt;!&ndash;                  <div class="linkGroup">&ndash;&gt;-->
<!--&lt;!&ndash;                    <div class="vx-col flex-col justify-center">&ndash;&gt;-->
<!--&lt;!&ndash;                      <div class="w-full">&ndash;&gt;-->
<!--&lt;!&ndash;                        <p class="color-gray colorSecondary mb-2 label">&ndash;&gt;-->
<!--&lt;!&ndash;                          {{$t("Sign Up Link")}}&ndash;&gt;-->
<!--&lt;!&ndash;                        </p>&ndash;&gt;-->
<!--&lt;!&ndash;                        <div class="groupButton flex mb-4 relative">&ndash;&gt;-->
<!--&lt;!&ndash;                          <div class="leftControl">&ndash;&gt;-->
<!--&lt;!&ndash;                            <input&ndash;&gt;-->
<!--&lt;!&ndash;                              type="text"&ndash;&gt;-->
<!--&lt;!&ndash;                              v-model="linkDk"&ndash;&gt;-->
<!--&lt;!&ndash;                              readonly="readonly"&ndash;&gt;-->
<!--&lt;!&ndash;                              disabled&ndash;&gt;-->
<!--&lt;!&ndash;                              class="form-control w-full text-base pl-2"&ndash;&gt;-->
<!--&lt;!&ndash;                            />&ndash;&gt;-->
<!--&lt;!&ndash;                          </div>&ndash;&gt;-->
<!--&lt;!&ndash;                          <div class="rightControl">&ndash;&gt;-->
<!--&lt;!&ndash;                            <button&ndash;&gt;-->
<!--&lt;!&ndash;                              class="btn button cursor-pointer"&ndash;&gt;-->
<!--&lt;!&ndash;                              v-clipboard:copy="linkDk"&ndash;&gt;-->
<!--&lt;!&ndash;                              @click="saoChep"&ndash;&gt;-->
<!--&lt;!&ndash;                            >&ndash;&gt;-->
<!--&lt;!&ndash;                              {{$t("Copy")}}&ndash;&gt;-->
<!--&lt;!&ndash;                            </button>&ndash;&gt;-->
<!--&lt;!&ndash;                          </div>&ndash;&gt;-->
<!--&lt;!&ndash;                        </div>&ndash;&gt;-->
<!--&lt;!&ndash;                      </div>&ndash;&gt;-->
<!--&lt;!&ndash;                      <div class="w-3/4">&ndash;&gt;-->
<!--&lt;!&ndash;                        <p class="color-light-gray mb-2 colorSecondary label">&ndash;&gt;-->
<!--&lt;!&ndash;                          {{$t("Referral code")}}&ndash;&gt;-->
<!--&lt;!&ndash;                        </p>&ndash;&gt;-->
<!--&lt;!&ndash;                        <div class="groupButton flex mb-4 relative">&ndash;&gt;-->
<!--&lt;!&ndash;                          <div class="leftControl">&ndash;&gt;-->
<!--&lt;!&ndash;                            <input&ndash;&gt;-->
<!--&lt;!&ndash;                              type="text"&ndash;&gt;-->
<!--&lt;!&ndash;                              v-model="codeGioiThieu"&ndash;&gt;-->
<!--&lt;!&ndash;                              readonly="readonly"&ndash;&gt;-->
<!--&lt;!&ndash;                              disabled&ndash;&gt;-->
<!--&lt;!&ndash;                              class="form-control w-full text-base pl-2"&ndash;&gt;-->
<!--&lt;!&ndash;                            />&ndash;&gt;-->
...
<!--&lt;!&ndash;                            <button&ndash;&gt;-->
<!--&lt;!&ndash;                              class="btn button cursor-pointer"&ndash;&gt;-->
<!--&lt;!&ndash;                              v-clipboard:copy="codeGioiThieu"&ndash;&gt;-->
<!--&lt;!&ndash;                              @click="saoChep"&ndash;&gt;-->
<!--&lt;!&ndash;                            >&ndash;&gt;-->
<!--&lt;!&ndash;                              {{$t("Copy")}}&ndash;&gt;-->
<!--&lt;!&ndash;                            </button>&ndash;&gt;-->
...
<!--                <div class="subBanner  flex items-center">-->
<!--                  <div class="container">-->
<!--                    <div class="vx-row items-center">-->
<!--                      <div class="col">-->
<!--                        <div class="flex boxContent h-full items-center ml-5">-->
<!--                          <div class="mt-20 grid grid-cols-1 gap-y-4">-->
<!--                            <div>-->
...
<!--                                    <p class="mb-1 title">{{$t("Invite friend")}}</p>-->
<!--                                    <p class="color-white-50 mb-0 des">-->
<!--                                      {{$t("Invite friends to register")}} Bitgainz {{$t("via link")}}-->
<!--                                    </p>-->
<!--                                  </div>-->
<!--                                </div>-->
<!--                              </div>-->
<!--                            </div>-->
<!--                            <div>-->
<!--                              &lt;!&ndash; <div class="borderSubBanner"></div> &ndash;&gt;-->
<!--                              <div class="flex items-center">-->
<!--                                <div>-->
...
<!--                                <div>-->
<!--                                  <div class="textContent">-->
<!--                                    <p class="mb-1 title">{{$t("Your friend sign up")}}</p>-->
<!--                                    <p class="color-white-50 mb-0 des">-->
<!--                                      {{$t("Your friend (F1) accepts the invitation, completes registration and transaction")}}-->
<!--                                    </p>-->
<!--                                  </div>-->
<!--                                </div>-->
<!--                              </div>-->
...
<!--                                <div>-->
<!--                                  <div class="textContent">-->
<!--                                    <p class="mb-1 title">{{$t("Get corresponding commission")}}</p>-->
<!--                                    <p class="color-white-50 mb-0 des">-->
<!--                                      {{$t("You will get corresponding commission from your partner")}}-->
<!--                                    </p>-->
<!--                                  </div>-->
<!--                                </div>-->
<!--                              </div>-->
...
<!--        </div>-->
<!--      </div>-->
<!--&lt;!&ndash; membership policy &ndash;&gt;-->
<!--<div class="membership-policy">-->
<!--                <div class="policy-text">-->
<!--                  {{$t("Bitgainz")}}-->

<!--                </div>-->
<!--                <table class="tb-policy-index">-->

<!--                    <th>{{$t("Level")}}</th>-->
<!--                    <th>{{$t("Agent_commision")}}</th>-->
<!--                    <th>{{$t("Trade_commision")}}</th>-->
<!--                    <th>{{$t("CONDITION_F1")}}</th>-->
<!--                    <th>{{$t("TRADE_VOLUME_CONDITION")}}</th>-->
...
<!--              You need to pay $100 to purchase Affiliate Rights. Want to-->
<!--              continue?-->
<!--            </div>-->
...
<!--                        </h5>-->
<!--                        <span v-if="vip_lv == 5" class=" lv5-notifi text-center md:text-center text-xs italic">* Conditions to maintain the level</span>-->
...
<!--                              >16,000</span-->
<!--                              >-->
<!--                              &lt;!&ndash; <span class="colorGray" v-if="vip_lv == 6"-->
<!--                                >64,000</span-->
<!--                              >-->
...
<!--                                  Total number of new traders ({{ ttngdTN }})-->
<!--                                </p>-->
<!--                                <p class="totalAgency colorBlue mb-4">-->
<!--                                  Total number of new dealers ({{ tsdlmtn }})-->
<!--                                </p>-->
<!--                                <p class="colorDanger">-->
...
<!--                                </p>-->
<!--                                <p class="totalReferral colorSuccess mb-4">-->
<!--                                  Total number of new traders ({{ tslgdmtt  }})-->
<!--                                </p>-->
<!--                                <p class="totalAgency colorBlue mb-4">-->
<!--                                  Total number of new dealers ({{ tsdlmtt }})-->
<!--                                </p>-->
<!--                                <p class="colorDanger">-->
<!--                                  Total new commissions ({{ tshhmtt }})-->
<!--                                </p>-->
<!--                              </div>-->
<!--                              <div class="vx-col w-full lg:w-2/3">-->
<!--                                <div class="wrap-chart bgPrimary">-->
...
<!--                                >Email support</a-->
<!--                              >-->
<!--                              &lt;!&ndash; <a :href="`mailto:contact@${hostName}`" class="elipText white text-base ml-2 getIntouch-value">contact@{{hostName}}</a> &ndash;&gt;-->
<!--                            </p>-->
<!--                            <p class="white-50 text-base mb-2 getIntouch-label">-->
<!--                              24/7 Support-->
<!--                            </p>-->
...
<!--                &lt;!&ndash; <div class="vx-col w-full lg:w-4/12 lg:mb-5 lg:pr-0">Mỗi ngày mới, bạn sẽ nhận hoa hồng giao dịch từ tuyến dưới của ngày hôm trước.-->
...
<!--                          </th>-->
<!--                          &lt;!&ndash;<th class="colorSecondary2">Số nhà Giao dịch</th>&ndash;&gt;-->
...
<!--                          &lt;!&ndash;<td class="colorSecondary">{{ tr.soluongGD }}</td>&ndash;&gt;-->
<!--                          <td class="colorSecondary">-->
...
<!--                      </tbody>-->
<!--                    </table>-->
<!--                    &lt;!&ndash;<vs-pagination v-if="countPageHH > 0" class="mt-4 mb-2" :total="countPageHH" v-model="currentxHH"  @input="clickPageHH"></vs-pagination>-->
<!--                                            &ndash;&gt;-->
<!--                  </div>-->
<!--                  <div-->
<!--                    class="tableBackground bgSecondary trading-detail relative"-->
...
<!--                      </tbody>-->
<!--                    </table>-->
<!--                    &lt;!&ndash;<vs-pagination v-if="countPageHHVip > 0" class="mt-4 mb-2" :total="countPageHHVip" v-model="currentxHHVip"  @input="clickPageHHVip"></vs-pagination>-->
<!--                                            &ndash;&gt;-->
<!--                  </div>-->
<!--                </div>-->
<!--              </div>-->
...
<!--                    </h1>-->
<!--                    <br/>-->
<!--                    <h3 class="ml-5 textTime">Summary: {{formatPrice(summaryTradingVolume, 2)}}</h3>-->
<!--                    <div-->
...
<!--        <img width="100%" :src="require('@/assets/images/sky/update-rank-new.png')" />-->
<!--      </vs-popup>-->
<!--    </div>-->
<!--  </div>-->
<!--</template>-->
...
<!--      setTimeout(() => {-->
<!--        this.$router.push("/user/balance").catch((e) => {-->
<!--          console.log(e);-->
<!--        });-->
<!--      }, 500);-->
<!--    },-->
...
<!--          this.ttngdTN = d.ttngdTN ? d.ttngdTN :0;-->
<!--          try {-->
...
<!--            pA0.update({ y: d.tttngdT1 }, true);-->
<!--            pA1.update({ y: d.tttngdT2 }, true);-->
<!--            pA2.update({ y: d.tttngdT3 }, true);-->
<!--            pA3.update({ y: d.tttngdT4 }, true);-->
...
<!--              nA1.update({ y: d.tsngdTTMoi1 }, true);-->
<!--              nA2.update({ y: d.tsngdTTMoi2 }, true);-->
<!--              nA3.update({ y: d.tsngdTTMoi3 }, true);-->
<!--            }-->
...
<!--          this.summaryTradingVolume  = this.datalistAgency.reduce(function (acc, obj) { return acc + obj.tklgd; }, 0);-->
<!--        } else {-->
<!--          this.datalistAgency = [];-->
<!--        }-->
<!--      });-->
...
<!--    console.log(getData.vip,"getdatavip")-->
