        ...
        <div class="vx-col w-full mb-base">
          <div class="vx-row">
            <div class="vx-col centerx md:w-1/2 lg:w-3/12 xl:w-3/12">
              ...
              <vs-radio
                v-model="settingJson.default_netw_pay"
                vs-name="radio_netw_pay"
                vs-value="ct"
                >Chính thức</vs-radio
              >
              <p></p>
...
export default {
  ...
  data() {
    return {
      ...
      settingJson: {
        ...
        ADDRESS_ETH_USDT: "",
        // PRIVATE_KEY_ADDRESS_ETH_USDT: "",//X
        ADDRESS_ETH_TRANSACTION: "",
        // PRIVATE_KEY_ETH_TRANSACTION: "",//X
  ...
  methods: {
    ...
    connectSever() {
      ...
      this.connection = new WebSocket(process.env.VUE_APP_BASE_URL_SOCKET_SYS);
