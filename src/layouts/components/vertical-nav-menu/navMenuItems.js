...
export default [
  ...
  },
  {
    ...
    items: [
      ...
      // {
      //   url: '/account/list-marketing-account',
  ...
  },
  {
    ...
    items: [
      ...
      {
        url: '/account/info-bank',
        name: "Tài khoản admin",
        icon: "UserCheckIcon",
        slug: "list-agency-account",
      },
      {
        url: '/account/info-bank-user-list',
        name: "Tài khoản User",
        icon: "UserCheckIcon",
        slug: "list-agency-account",
      }
  ...
  //           name: "Reset Password",
  //           slug: "login-reset-password",
  //           i18n: "ResetPassword",
  //           target: '_blank',
  //         },
  //         {
  //           url: '/login/lock-screen',
  //           name: "Lock Screen",
  //           slug: "login-lock-screen",
  //           i18n: "LockScreen",
  //           target: '_blank',
  //         },
  //       ]
