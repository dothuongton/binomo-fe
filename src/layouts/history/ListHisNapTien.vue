  ...
  <div id="list-history-deposit" class="data-list-container">
    ...
    <div id="loading-corners" class="vs-con-loading__container">
      ...
      >
        <div
          slot="header"
          class="flex flex-wrap-reverse items-center flex-grow justify-between table-transaction-header"
        >
          <div
            class="flex flex-wrap-reverse items-center data-list-btn-container mt-5"
          >
            <!-- ACTION - DROPDOWN -->
            <vs-dropdown
              vs-trigger-click
...
<!--            />-->
            <div class="flex">
              ...
              <datepicker
                class="ml-5 focus:border-opacity-50"
                id="endDatePicker"
                v-model="endDate"
              ></datepicker>
            ...
            <div class="mb-4">
              <label class="ml-3" for="typeSelect">Chọn Type:</label>
          ...
          <vs-dropdown
            vs-trigger-click
            class="cursor-pointer mb-7 mr-4 items-per-page-handler"
          >
            <div
...
export default {
  ...
  methods: {
    filterType(){
    AuthenticationService.getDepositListHistoryType(this.valueType)
      .then((resp) => {
    ...
    onFilterData(config) {
      ...
      this.productsFake = this.productsFake.filter((item) => {
    ...
    reloadList() {
      ...
      if(this.startDate && this.endDate){
        ...
        this.getListAddMoney(queryString)
        ...
        this.getListAddMoney(query)
      }
    },
    getListAddMoney(query){
      AuthenticationService.getDepositListHistory(query).then((resp) => {
