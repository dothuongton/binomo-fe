...
import Vue from "vue";
import DataAgencyDetail from "@/layouts/account/slidebar/DataAgencyDetail";
import DataTradingAgencyDetail from "@/layouts/account/slidebar/DataTradingAgencyDetail";
  ...
  methods: {
    viewDataAgency(id){
     ...
     this.toggleAgencyDataSidebar(true)
      if (this.currentIdAgency) {
        AuthenticationService.getInfoUserAdmin(this.currentIdAgency)
        .then(res=>{
          this.dataAgencyDetail = res.data.data
        })

        AuthenticationService.getNguoiGioiThieuAdmin(this.currentIdAgency)
          .then(res=>{
    ...
    viewDataTradingAgency(email){
      ...
      if(email){
        ...
        AuthenticationService.getListHistoryOrderTradeAdmin(result)
          .then(res=>{
