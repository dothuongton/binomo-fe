            ...
            <div class="flex mb-4 mt-3">
              ...
              <div class="mt-2 mt-5">
                ...
                <select class="type-select" id="typeSelect" v-model="valueType">
                  <option class="mt-2" v-for="(item, i) in dataValueType" :key="i" :value="item.value">{{ item.text }}</option>
                </select>
              </div>
...
import DataViewSidebar from '@/pages/agency/account/slidebar/HandleMoneyRut.vue'
import Vue from 'vue'
...
`;
    ...
    reloadList() {
      ...
      if(this.startDate && this.endDate && this.startDate < this.endDate ){
        ...
        AuthenticationService.getWithdrawalListHistoryOfAgency(queryString)
          .then((resp) => {
        ...
        AuthenticationService.getWithdrawalListHistoryOfAgency()
          .then((resp) => {
    ...
    getDTRut() {
      AuthenticationService.getRevenueRutOfAgency()
        .then((resp) => {
          let g = resp.data;
          if (g.success == 1) {
