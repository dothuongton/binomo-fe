    ...
    <div class="vx-row">
      ...
      <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
        <vx-card title="Người đăng ký">
          <h2 class="mb-1 font-bold">{{ dataGet.nNDK || "" }}</h2>
        </vx-card>
      ...
      <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
        <vx-card title="Đã xác minh">
          <h2 class="mb-1 font-bold">{{ dataGet.nNDXM || "" }}</h2>
        </vx-card>
      ...
      <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">
        <vx-card title="Đại lý">
          <h2 class="mb-1 font-bold">{{ dataGet.nDL || "" }}</h2>
        </vx-card>
...
import analyticsData from "@/pages/agency/ui-elements/card/analyticsDataAgency.js";
...
export default {
  ...
  methods: {
    ...
    changeDT(val) {
      ...
      AuthenticationService.getShowDTOfAgency(obj).then((res) => {
        let g = res.data;
  ...
  created() {
    AuthenticationService.getAnalyticsOfAgency()
      .then((res) => {
        ...
        } else if (res.data.success == 4 || res.data.success == 5) {
