              ...
              >
                ...
                <!-- <vs-dropdown vs-trigger-click class="ml-auto md:block hidden cursor-pointer">
                  ...
                  <vs-dropdown-menu class="w-32">
                    <vs-dropdown-item>
                      <div @click="$router.push('/login/profile').catch(() => {})" class="flex items-center">
...
//import LogRegForGet  from '@/login/user/LogRegForGet.vue'
  ...
  data() {
    return {
      ...
      steps: [
        ...
        // {
        //   target  : '.vx-navbar__starred-login',
...
.customeAffiliateCommission {
  background: url("~@/assets/images/landing_v2/icon-dp.png") no-repeat right
    center;
}
.table-bordered td,
.table-bordered th {
...
.router-content {
  .content-area__content {
    ...
    #tradeHisPage {
      background: #1c1901;
      box-shadow: 0px 3px 10px 3px #ffe98940 inset;
      border-radius: 10px;
    }
    #wallet {
