          ...
          <div class="boxAddress">
                ...
                <div v-if="!activeNRT">
                  ...
                  >
                    ...
                    >
                      ...
                      <span class="transfer-network-item-fee"
                        >Fee: {{ getSetSys.feeRutPaypalAcc }} USD</span
                      >
                    </li>
                  </ul>
                </div>
                <div class="deposit_widthdraw_box">
                  <div class="form-group relative mt-4">
                    ...
                    <input
                      ...
                      v-model="amount"
                      decimal="true"
                      :placeholder="`Minimum amount: ${getSetSys.minWithdrawalPaypal} USDT`"
                      class="form-control"
                    />
                    <button
                  ...
                  <div class="text-center address">
                    <div class="text-center p-4" v-if="isNap">
                      ...
                      <i
                        >* {{$t("Note: If you don't see the Popup window please please go to browser Settings unblock Pop-ups up")}}</i
                      >
                    </div>
                ...
                <div v-if="!pop2FAokPay && !DISABLE_2FA">
                  <div class="text-center address">
                    <small class="colorRed enable2fa" v-if="!getData.c2fa"
                      >You must enable 2FA to request a withdrawal</small
                    >
                    <vs-button
                      ...
                      type="filled"
                      @click="Withdrawal()"
                      >Withdraw money</vs-button
                    >
                  </div>
                </div>
                <div v-else-if="!DISABLE_2FA">
                  <div class="form-group relative">
                    <h4 class="colorSecondary2"><i>Enter the 2FA code *</i></h4>
                    <input
                      type="text"
                      v-model="code2FA"
            ...
            <div v-else>
                ...
                >
                  ...
                  >
                    <span class="transfer-network-item-label">{{
                      !activeNRT ? $t('Internal') : "BEP20 (BSC)"
                    }}</span>
              ...
              >
                ...
                <div class="form-group relative">
                  <h4 class="colorSecondary2">Note <i>{{$t('(Optional)')}}</i></h4>
                  <input
                    type="text"
                    v-model="noteRut"
...
export default {
    ...
    WithdrawalOKPay() {
      if (!this.DISABLE_2FA) {
        ...
        if (!this.code2FA.trim()) {
          return this.$vs.notify({
            text: "You must enter 2FA to request a withdrawal",
            color: "danger",
            position: "top-right",
            iconPack: "feather",
            icon: "icon-x-circle",
      ...
      if (this.isActiveSelectTransNB) {
        ...
        AuthenticationService.withdrawalUserNoiBo(obj).then((res) => {
          ...
          if (d.success == 5) {
            return this.$vs.notify({
              text: "Can't transfer money to this player.",
              iconPack: "feather",
              icon: "icon-check",
              color: "danger",
              position: "top-right",
  ...
  created() {
    ...
    document.addEventListener('keyup', function (evt) {
      if (evt.keyCode === 27) {
        if(that.isDepositOpen == true){
          that.isDepositOpen = false
        }
      }
    });
