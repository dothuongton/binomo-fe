...
<template>
  ...
  >
    <div class="mt-6 flex items-center justify-between px-6">
      <div @click.stop="isSidebarActiveLocal = false" class="cursor-pointer">
        <svg
          width="46"
          height="45"
          viewBox="0 0 46 45"
        ...
        >
          <path
            d="M11.2719 19.6875L26.9656 3.99375L23 0L0.5 22.5L23 45L26.9656 41.0344L11.2719 25.3125H45.5V19.6875H11.2719Z"
            fill="#B1B1B1"
          />
        </svg>
      </div>
      ...
      <div @click.stop="isSidebarActiveLocal = false" class="cursor-pointer">
        ...
        >
          <path
            d="M31.2087 14.5547C31.2087 14.3337 31.0279 14.1529 30.8069 14.1529L27.4922 14.168L22.5 20.1194L17.5128 14.173L14.1931 14.1579C13.9721 14.1579 13.7913 14.3337 13.7913 14.5597C13.7913 14.6551 13.8265 14.7455 13.8867 14.8209L20.4208 22.6055L13.8867 30.385C13.826 30.4587 13.7924 30.5508 13.7913 30.6462C13.7913 30.8672 13.9721 31.048 14.1931 31.048L17.5128 31.0329L22.5 25.0815L27.4872 31.0279L30.8019 31.043C31.0229 31.043 31.2037 30.8672 31.2037 30.6412C31.2037 30.5458 31.1685 30.4554 31.1083 30.38L24.5843 22.6004L31.1183 14.8159C31.1786 14.7455 31.2087 14.6501 31.2087 14.5547Z"
            fill="#B1B1B1"
          />
          <path
            d="M22.5 0C10.0748 0 0 10.0748 0 22.5C0 34.9252 10.0748 45 22.5 45C34.9252 45 45 34.9252 45 22.5C45 10.0748 34.9252 0 22.5 0ZM22.5 41.183C12.1842 41.183 3.81696 32.8158 3.81696 22.5C3.81696 12.1842 12.1842 3.81696 22.5 3.81696C32.8158 3.81696 41.183 12.1842 41.183 22.5C41.183 32.8158 32.8158 41.183 22.5 41.183Z"
            fill="#B1B1B1"
          />
        </svg>
      </div>
    ...
    >
      <div class="p-6">
        <h4 class="ml-12 text-3xl font-bold">{{$t('Account Verification')}}</h4>
        <!-- NICKNAME -->
        <div class="vx-row">
          <form-wizard
            color="#454545"
            ...
            :finishButtonText="`${!verify ? 'Done' : 'Change'}`"
            @on-complete="formSubmitted"
          >
            <tab-content class="mb-5 px-16">
              <!-- tab 1 content -->
              <div class="vx-row">
                <p class="d-flex w-full text-xl">{{$t('Personal information')}}</p>
                ...
                <div class="vx-col md:w-1/2 w-full mt-5">
                  <vs-input :label="$t('First Name')" v-model="last_n" class="w-full" />
                </div>
                <div class="vx-col w-full mt-5">
                  <vs-input
                    :label="$t('ID/Passport Number')"
                    v-model="smcnn"
                    class="w-full"
                  />
                </div>
                <div class="vx-col w-full mt-5">
                  ...
                  <label for="select-country" class="label-select-country">{{$t('Nation')}}</label>
                  <select id="select-country" v-model="country" class="w-full select-large mt-4">
                    <option v-for="(item, index) in cityOptions" :key="index" :value="item.value" class="w-full mb-1">
                      {{item.text}}
                    </option>
                  </select>
                </div>
            ...
            <!-- tab 2 content -->
            <tab-content class="mb-5 upl px-16">
              <div class="d-flex w-full text-2xl mb-6">
                {{$t('Identity verification')}}
              </div>
              <div class="ml-4 mb-6">
                {{$t('1. Please ensure that the photograph is complete and clear, with formatting JPG, PNG, JPEG.')}} <br />
                {{$t('2. Take a photo of your ID/Passport. Photos need to be bright and clear, no lost corners.')}}
              </div>
              <div class="vx-row m-0 mb-3 px-8">
                <div class="w-full pt-2 pb-2">
                  <div class="mb-4">- {{$t('Front side of ID card/Passport')}}</div>
                </div>
              ...
              <div class="vx-row m-0 mb-3 px-8">
                <div class="w-full pt-2 pb-2">
                  <div class="w-full pt-2 pb-2">
                    <div class="mb-4">- {{$t('Back side of ID card/Passport')}}</div>
                  </div>
                </div>
                <div class="w-1/2 mb-2">
                  <label
            ...
            <tab-content class="mb-5 px-16">
              <div class="vx-row">
                <div class="d-flex w-full mb-4 text-xl">{{$t('Consider')}}</div>
                <div class="vx-col w-full">
                  <p class="text-center" v-if="!verify">
                    {{$t('Press')}}
                    <span class="font-bold text-lg text-white">{{$t('Done')}}</span>
                    {{$t('to complete. We will review your information!')}}
                  </p>
                  <p class="text-center" v-if="verify">
...
[dir] .theme-dark .wizard-icon-container {
