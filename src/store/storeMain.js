...
import moduleECommerce from "@/store/eCommerce/moduleECommerce";
...
export default new Vuex.Store({
  ...
  state: {
    ...
    notifyBonus:[],
    isTransferPop:false,
    isConfirmOrderBet:false,
    isOpenNotifyDropDown:true
  },
  mutations: {
    // ////////////////////////////////////////////
    // UI
    ...
    IS_OPEN_NOTIFY_DROPDOWN(state, val) {
      if (typeof val !== "undefined") {
        state.isOpenNotifyDropDown = val;
      } else {
        state.isOpenNotifyDropDown = !state.isOpenNotifyDropDown;
      }
    },
    SET_IS_SCROLL_TRADING(state, value) {
      state.isScrollTrading = value;
    },
    SET_NOTIFY_BONUS(state, value) {
      state.notifyBonus = value;
    },
    SET_IS_TRANSFER_POP_MONEY(state, value) {
      state.isTransferPop = value;
    },
    SET_IS_CONFIRM_ORDER_BET(state, value) {
      state.isConfirmOrderBet = value;
    },
    ...
    CHANGE_SWITCH_2FA(state, val){
      state.switch2FactorAuthen = val;
    }
  },
  actions: {
