...
const router = new Router({
    ...
    // =============================================================================
        ...
        // =============================================================================
                ...
                // {
                //   path: '/account/list-marketing-account',
                //   name: 'list-marketing-account',
                //   component: () => import('./layouts/account/AccountMarketingList.vue'),
                //   meta: {
                //     breadcrumb: [
                //       { title: 'Trang chủ', url: '/' },
                //       { title: 'Danh sách tài khoản marketing', active: true },
                //     ],
                //     pageTitle: 'Account Marketing',
                //     rule: 'editor'
                //   },
                // },
                {
                  ...
                  name: 'list-marketing-account',
                  component: () => import('./layouts/bank/BankInfoList.vue'),
                  meta: {
                    breadcrumb: [
                      { title: 'Trang chủ', url: '/' },
                      { title: 'Ngân hàng Admin', active: true },
                    ],
                ...
                {
                  path: '/account/info-bank-user-list',
                  name: 'list-info-bank-user',
                  component: () => import('./layouts/bank/BankInfoListUser.vue'),
                  meta: {
                    breadcrumb: [
                      { title: 'Trang chủ', url: '/' },
                      { title: 'Thông tin ngân hàng User', active: true },
                    ],
                    pageTitle: 'User Bank Information',
                    rule: 'editor'
                  },
                },
        ...
        // =============================================================================
                ...
                {
                    path: '/login/knowledge-base/category',
                ...
                {
                    path: '/login/knowledge-base/category/question',
    ...
    // =============================================================================
        ...
        // =============================================================================
                ...
                // },
                // {
                //     path: '/login/lock-screen',
                //     name: 'page-lock-screen',
                //     component: () => import('@/views/login/LockScreen.vue'),
                //     meta: {
                //         rule: 'editor'
                //     }
                // },
...
router.beforeEach((to, from, next) => {
    ...
    //firebase.auth().onAuthStateChanged(() => {
        ...
        //     to.path === "/login/error-404" ||
        //     to.path === "/login/error-500" ||
        //     to.path === "/login/register" ||
        //     to.path === "/callback" ||
        //     to.path === "/login/comingsoon" ||
        ...
        //     router.push({ path: '/login/login', query: { to: to.path } })
        //   }
        // }
